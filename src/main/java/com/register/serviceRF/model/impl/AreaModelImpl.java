...
import com.register.serviceRF.model.AreaModel;
import com.register.serviceRF.model.AreaSoap;
...
/**
 * The base model implementation for the Area service. Represents a row in the &quot;RF_Area&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.register.serviceRF.model.AreaModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AreaImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see AreaImpl
 * @see com.register.serviceRF.model.Area
 * @see com.register.serviceRF.model.AreaModel
 * @generated
 */
@JSON(strict = true)
public class AreaModelImpl extends BaseModelImpl<Area> implements AreaModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a area model instance should use the {@link com.register.serviceRF.model.Area} interface instead.
     */
    public static final String TABLE_NAME = "RF_Area";
    public static final Object[][] TABLE_COLUMNS = {
            ...
            { "title", Types.VARCHAR },
            { "areaCode", Types.BIGINT },
            { "inArchive", Types.BOOLEAN }
        };
    public static final String TABLE_SQL_CREATE = "create table RF_Area (uuid_ VARCHAR(75) null,areaId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(75) null,areaCode LONG,inArchive BOOLEAN)";
    public static final String TABLE_SQL_DROP = "drop table RF_Area";
    public static final String ORDER_BY_JPQL = " ORDER BY area.areaId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY RF_Area.areaId ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.register.serviceRF.model.Area"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.register.serviceRF.model.Area"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.register.serviceRF.model.Area"),
            true);
    public static long AREAID_COLUMN_BITMASK = 1L;
    public static long COMPANYID_COLUMN_BITMASK = 2L;
    public static long GROUPID_COLUMN_BITMASK = 4L;
    public static long INARCHIVE_COLUMN_BITMASK = 8L;
    public static long TITLE_COLUMN_BITMASK = 16L;
    public static long UUID_COLUMN_BITMASK = 32L;
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.com.register.serviceRF.model.Area"));
    ...
    public Object clone() {
        ...
        areaImpl.setTitle(getTitle());
        areaImpl.setAreaCode(getAreaCode());
        areaImpl.setInArchive(getInArchive());
    ...
    public void resetOriginalValues() {
        ...
        areaModelImpl._originalTitle = areaModelImpl._title;

        areaModelImpl._originalInArchive = areaModelImpl._inArchive;

        areaModelImpl._setOriginalInArchive = false;
    ...
    public CacheModel<Area> toCacheModel() {
        ...
        areaCacheModel.title = getTitle();

        String title = areaCacheModel.title;

        if ((title != null) && (title.length() == 0)) {
            areaCacheModel.title = null;
        }

        areaCacheModel.areaCode = getAreaCode();

        areaCacheModel.inArchive = getInArchive();
