 ...
 * @generated
 */
public class AreaSownFieldLocalServiceClp implements AreaSownFieldLocalService {
    ...
    public AreaSownFieldLocalServiceClp(
        ...
        _methodName23 = "getAreaSownFields";

        _methodParameterTypes23 = new String[] { "long", "long" };

        _methodName24 = "getAreaSownFields";

        _methodParameterTypes24 = new String[] { "long", "long", "int", "int" };

        _methodName25 = "getAreaSownFieldsCount";

        _methodParameterTypes25 = new String[] { "long", "long" };

        _methodName26 = "addAreaSownField";
        ...
        _methodName27 = "deleteAreaSownField";

        _methodParameterTypes27 = new String[] {
                "long", "com.liferay.portal.service.ServiceContext"
            };

        _methodName28 = "updateAreaSownField";
    ...
    public com.register.serviceRF.model.AreaSownField addAreaSownField(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(areaSownField) });
        } catch (Throwable t) {
        ...
        return (com.register.serviceRF.model.AreaSownField) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.register.serviceRF.model.AreaSownField createAreaSownField(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { areaSownFieldsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.register.serviceRF.model.AreaSownField deleteAreaSownField(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { areaSownFieldsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.register.serviceRF.model.AreaSownField fetchAreaSownField(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { areaSownFieldsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.register.serviceRF.model.AreaSownField getAreaSownField(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { areaSownFieldsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.register.serviceRF.model.AreaSownField> getAreaSownFields(
        ...
        return (java.util.List<com.register.serviceRF.model.AreaSownField>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.register.serviceRF.model.AreaSownField> getAreaSownFields(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName23,
                    _methodParameterTypes23, new Object[] { groupId, farmerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.register.serviceRF.model.AreaSownField> getAreaSownFields(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName24,
                    ...
                    new Object[] { groupId, farmerId, start, end });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public int getAreaSownFieldsCount(long goupeId, long farmerId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName25,
                    _methodParameterTypes25, new Object[] { goupeId, farmerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
