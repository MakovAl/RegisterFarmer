...
public class AreaLocalServiceClp implements AreaLocalService {
    ...
    public AreaLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName24 = "deleteArea";

        _methodParameterTypes24 = new String[] {
                "long", "com.liferay.portal.service.ServiceContext"
            };

        _methodName25 = "getAreas";

        _methodParameterTypes25 = new String[] { "long" };

        _methodName26 = "getAreas";

        _methodParameterTypes26 = new String[] { "long", "int", "int" };

        _methodName27 = "getAreas";

        _methodParameterTypes27 = new String[] { "long", "java.lang.Boolean" };

        _methodName28 = "getAreas";

        _methodParameterTypes28 = new String[] {
                "long", "java.lang.Boolean", "int", "int"
            };

        _methodName29 = "getArea";

        _methodParameterTypes29 = new String[] { "long", "java.lang.Boolean" };

        _methodName30 = "getAreas";

        _methodParameterTypes30 = new String[] { "long", "java.lang.String" };

        _methodName31 = "getAreas";

        _methodParameterTypes31 = new String[] { "java.lang.String" };

        _methodName32 = "getAreasCount";

        _methodParameterTypes32 = new String[] { "long" };

        _methodName33 = "getAreasCount";

        _methodParameterTypes33 = new String[] { "long", "java.lang.Boolean" };

        _methodName34 = "updateArea";
    ...
    public com.register.serviceRF.model.Area addArea(
        ...
        return (com.register.serviceRF.model.Area) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.register.serviceRF.model.Area getArea(long areaId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { areaId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.register.serviceRF.model.Area> getAreas(
        ...
        return (java.util.List<com.register.serviceRF.model.Area>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.register.serviceRF.model.Area getArea(long areaId,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName29,
                    ...
                    new Object[] { areaId, ClpSerializer.translateInput(
                            inArchive) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public int getAreasCount(long goupeId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName32,
                    _methodParameterTypes32, new Object[] { goupeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
